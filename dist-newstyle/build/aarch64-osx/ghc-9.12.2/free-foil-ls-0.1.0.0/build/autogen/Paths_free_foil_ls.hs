...
-- at runtime using the environment variable free_foil_ls_bindir.
...
-- environment variable free_foil_ls_libdir.
...
-- using the environment variable free_foil_ls_dynlibdir.
...
-- runtime using the environment variable free_foil_ls_datadir.
...
-- variable free_foil_ls_libexedir.
...
-- using the environment variable free_foil_ls_sysconfdir.
...
bindir     = "/Users/kf/.cabal/bin"
libdir     = "/Users/kf/.cabal/lib/aarch64-osx-ghc-9.12.2-ea3d/free-foil-ls-0.1.0.0-inplace"
dynlibdir  = "/Users/kf/.cabal/lib/aarch64-osx-ghc-9.12.2-ea3d"
datadir    = "/Users/kf/.cabal/share/aarch64-osx-ghc-9.12.2-ea3d/free-foil-ls-0.1.0.0"
libexecdir = "/Users/kf/.cabal/libexec/aarch64-osx-ghc-9.12.2-ea3d/free-foil-ls-0.1.0.0"
sysconfdir = "/Users/kf/.cabal/etc"

getBinDir     = catchIO (getEnv "free_foil_ls_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "free_foil_ls_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "free_foil_ls_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "free_foil_ls_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "free_foil_ls_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "free_foil_ls_sysconfdir") (\_ -> return sysconfdir)
